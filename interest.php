...
include("includes/header.php");
 ...
 ?>
   ...
   <link rel="stylesheet" href="assets/css/intereststyle.css" type="text/css" >
   <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">   <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Lato">
	<script src="assets/js/interestselect.js"></script>

   <!--------------------------------------------->	  
   <!--Add javascript here to overwrite title----->
   <!--------------------------------------------->	

      <section id="header" class="jumbotron text-center">
         <h1 class="display-4 ">What's your Interest</h1>
         <p class="lead">People are waiting to meet you :) </p>
         <p class="lead">Please Allow Us To get Your Location </p>
      </section>
 ...
 <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQI0rLvTLZpmlwClNRZwyZUCeUAflptrg&callback=initMap">
    </script> 
      <div id="map"></div>
    <script>

      var map, infoWindow,lat=null,lng=null,name;
      ...
      function initMap() {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            console.log(name);
            $.ajax({  
                      url: 'includes/handlers/ajax_map.php',
                      type: 'post',
                      data: {latitude:lat,longitude:lng,username:name},
...
<hr>
       ...
       <!--  <div class="d-flex justify-content-center"><a href="index.php" class="btn btn-danger" name="done">Done</a></div>-->
      <!-- <div class="d-flex justify-content-center"><form action="interest.php" method="POST"><input  class="btn btn-danger" type="submit" value="Done" name="done"></form></div>-->
       <div class="d-flex justify-content-center"><input type="button"  class="btn btn-danger"  value="DONE" onclick="str('<?php echo $userLoggedIn; ?>',lat,lng)" name="done"></div>
         <br>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="row">
                     <div class="col-lg-4 col-md-6 mb-3 subint" data-name="Music">
                     ...
                     <div class="col-lg-4 col-md-6 subint" data-name="Music">
               ...
               <div class="modal-footer pr-3">
                  <button type="button" class="btn btn-primary musicbtn " data-dismiss="modal" onclick="">Save </button><!--Hereeeeeee-->
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
				   ...
				   <div class="row">
                     <div class="col-lg-4 col-md-6 mb-3 subint" data-name="Movies">
                     ...
                     <div class="col-lg-4 col-md-6 subint" data-name="Movies">
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-md-6 mb-4 subint" data-name="Movies">
               ...
               <div class="modal-footer">
                  <button type="button" class="btn btn-primary musicbtn " data-dismiss="modal" >Save </button>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-md-6 subint" data-name="Games">
                        <img class="card-img-top mb-3" src="https://c1.staticflickr.com/9/8110/8638067405_786d6104b5_b.jpg">
						 <div class = "overlay">
                         	<h4 class="hide">Clash of Clans</h4>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 subint" data-name="Games">
                        <img class="card-img-top mt-3" src="https://upload.wikimedia.org/wikipedia/en/thumb/0/08/DotA2.jpg/330px-DotA2.jpg">
						 <div class = "overlay">
                           	<h4 class="hide">Dota 2</h4>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 subint" data-name="Games">
                        <img class="card-img-top " src="Call_of_Duty_Black_Ops_4_official_box_art%20(1).jpeg">
						 <div class = "overlay">
				    ...
				    <div class="row">
                     <div class="col-lg-4 col-md-6 subint" data-name="Games">
                        <img class="card-img-top " src="https://upload.wikimedia.org/wikipedia/en/thumb/7/77/League_of_Legends_logo.png/330px-League_of_Legends_logo.png">
						 <div class = "overlay">
                           	<h4 class="hide">League of Legends</h4>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 subint" data-name="Games">
                        <img class="card-img-top  mt-2" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/Need_For_Speed_logo.svg/1280px-Need_For_Speed_logo.svg.png">
						 <div class = "overlay">
                          	<h4 class="hide">Need for Speed</h4>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 subint" data-name="Games">
                        <img class="card-img-top" src="http://c1.staticflickr.com/3/2852/33848624946_4f501f796b_b.jpg">
						 <div class = "overlay">
      ...
      <div class="modal fade" id="techModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="row">
                     <div class="col-lg-4 col-md-6 mb-3 subint" data-name="Tech">
                     ...
                     <div class="col-lg-4 col-md-6 subint" data-name="Tech">
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-md-6 mb-3 subint" data-name="Software-Dev">
                     ...
                     <div class="col-lg-4 col-md-6 subint" data-name="Software-Dev">
                     ...
                     <div class="col-lg-4 col-md-6 subint mb-3" data-name="Software-Dev">
      ...
      <div class="modal fade" id="seriesModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
				            <div class="row">
                     <div class="col-lg-4 col-md-6 mb-3 subint" data-name="TV-Series">
                     ...
                     <div class="col-lg-4 col-md-6 subint" data-name="TV-Series">
      ...
      <div class="modal fade" id="insrtumentsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="row">
                     <div class="col-lg-4 col-md-6 mb-3 subint" data-name="Instruments" >
                     ...
                     <div class="col-lg-4 col-md-6 subint" data-name="Instruments">
      ...
      <div class="modal fade" id="sportsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="row">
                     <div class="col-lg-4 col-md-6 mb-3 subint" data-name="Sports">
                     ...
                     <div class="col-lg-4 col-md-6 subint" data-name="Sports">
      ...
      <div class="modal fade" id="booksModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="row">
                     <div class="col-lg-4 col-md-6 mb-3 subint"  data-name="Books">
                     ...
                     <div class="col-lg-4 col-md-6 subint" data-name="Books">
